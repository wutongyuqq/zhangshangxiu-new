 ...
 * 首页
 */
public class XsdQueryActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mPeijianAdapter.setDeleteClickListener(new KeHuXsdProAdapter.DeleteClickListener() {
            @Override
        ...
        mPeijianAdapter.setEditClickListener(new KeHuXsdProAdapter.EditClickListener() {
            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.peijianku:
                ...
                Intent intent2 = new Intent(XsdQueryActivity.this,KeHuPeijianSelectActivity.class);
            ...
            case R.id.project_ck:
                ...
                startActivity(new Intent(XsdQueryActivity.this,ProjectSelectActivity.class));

                break;
            case R.id.car_home_page:
            case R.id.car_home_page2:

                startActivityForResult(new Intent(XsdQueryActivity.this,KeHuQueryActivity.class),100);
                break;
            case R.id.paigong:
