 ...
 * 首页
 */
public class KeHuQueryActivity extends BaseActivity implements View.OnClickListener {
        ...
        rl_pj_one_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if("chakehu".equals(getIntent().getStringExtra("from"))){
                    ...
                    intent.setClass(KeHuQueryActivity.this, KeHuQueryOrderActivity.class);
