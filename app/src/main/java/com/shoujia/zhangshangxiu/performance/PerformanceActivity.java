...
public class PerformanceActivity extends BaseActivity implements View.OnClickListener{
	...
	TextView select_date_start,select_date_end,tv_base_info,tv_more_info,person_head,car_cp;
	ImageView query_btn;
	...
	private void initView() {
		...
		//person_head,car_cp
		person_head = findViewById(R.id.person_head);
		car_cp = findViewById(R.id.car_cp);
		person_head.setText("姓名："+sp.getString(Constance.USERNAME));
	...
	protected void updateUIThread(int msgInt) {
		...
		if(msgInt==101){
			...
			shigong_level.setText("施工绩效："+mJixiaoBaseInfo.repair_achievement);
			sale_level.setText("销售绩效:"+mJixiaoBaseInfo.sale_achievement);
		}else if(msgInt==102){
