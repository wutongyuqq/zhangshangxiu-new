 ...
 * 首页
 */
public class ProjectKehuShouyinActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getRealShouyinData() {
        Map<String, String> dataMap = new HashMap<>();
        dataMap.put("db", sp.getString(Constance.Data_Source_name));
        dataMap.put("function", "sp_fun_get_xsd_settle_accounts_info");
    ...
    private void receiveMoney(){
        ...
        Map<String, String> dataMap = new HashMap<>();
        dataMap.put("db", sp.getString(Constance.Data_Source_name));
        dataMap.put("function", "sp_fun_upload_xsd_receivables_data");
        ...
        dataMap.put("plate_number", sp.getString(Constance.CUSTOMER_NAME));
    ...
    private void updateJsData() {
        ...
        client.post(Util.getUrl(), dataMap, new IGetDataListener() {
            @Override
            public void onSuccess(String json) {
                startActivity(new Intent(ProjectKehuShouyinActivity.this,ProjectOrderActivity.class));
                finish();
            }
