 ...
 * 首页
 */
public class KeHuQueryOrderActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kehu_query_order);
        initView();
        initData();
        //getProjectListData();
    ...
    private void initView() {
        ...
        listview2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(KeHuQueryOrderActivity.this,XsdQueryActivity.class);
    ...
    private void getXsdInfo(){
        ...
        client.post(Util.getUrl(), dataMap, new IGetDataListener() {
            ...
            public void onSuccess(String json) {
                ...
                String state = (String) resMap.get("state");
                if ( "ok".equals(state)) {
                    //{"state":"ok","data":[{"xs_id":"AXS2007040001","khmc":"散客","pjbm":"15601-44011",
                    // "pjmc":"机油格","cd":"TOYOTA","dw":"个","rq":"2020-07-04 11:14:42","sl":"1.0000",
                    // "ssj":"100.04","je":"100.04"}],"pre_row_number":"end"}
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.peijianku:
                ...
                Intent intent2 = new Intent(KeHuQueryOrderActivity.this,KeHuPeijianSelectActivity.class);
                ...
                startActivity(new Intent(KeHuQueryOrderActivity.this,ProjectSelectActivity.class));

                break;

            case R.id.car_home_page2:

                startActivityForResult(new Intent(KeHuQueryOrderActivity.this,KeHuQueryActivity.class),100);
               // overridePendingTransition(0,0);


                break;
            case R.id.car_home_page:
                startActivityForResult(new Intent(KeHuQueryOrderActivity.this, KeHuQueryOrderActivity.class),100);
                overridePendingTransition(0,0);
                finish();
                break;
                case R.id.paigong:
            ...
            case R.id.total_jiesuan2:
                ...
                isToJiesuan=true;
                Intent intent = new Intent(KeHuQueryOrderActivity.this,ProjectJiesuanActivity.class);
